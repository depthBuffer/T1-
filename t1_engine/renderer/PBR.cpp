...
namespace T1
{
    ...
    PBR::PBR(Renderer* renderer)
    {
        ...
        T1::Shader *hdrToCubemap      = T1::Resources::LoadShader("pbr:hdr_to_cubemap", "shaders/pbr/cube_sample.vs", "shaders/pbr/spherical_to_cube.fs");
        T1::Shader *irradianceCapture = T1::Resources::LoadShader("pbr:irradiance", "shaders/pbr/cube_sample.vs", "shaders/pbr/irradiance_capture.fs");
        T1::Shader *prefilterCapture  = T1::Resources::LoadShader("pbr:prefilter", "shaders/pbr/cube_sample.vs", "shaders/pbr/prefilter_capture.fs");
        T1::Shader *integrateBrdf     = T1::Resources::LoadShader("pbr:integrate_brdf", "shaders/screen_quad.vs", "shaders/pbr/integrate_brdf.fs");
        ...
        m_ProbeDebugShader = T1::Resources::LoadShader("pbr:probe_render", "shaders/pbr/probe_render.vs", "shaders/pbr/probe_render.fs");
