...
namespace T1
{
    ...
    PostProcessor::PostProcessor(Renderer* renderer)
    {
        ...
        {
            m_PostProcessShader = T1::Resources::LoadShader("post process", "shaders/screen_quad.vs", "shaders/post_processing.fs");
        ...
        // down sample
        {
            ...
            m_DownSampleShader = T1::Resources::LoadShader("down sample", "shaders/screen_quad.vs", "shaders/post/down_sample.fs");
        ...
        // gaussian blur shader
        {
            ...
            m_OnePassGaussianShader = T1::Resources::LoadShader("gaussian blur", "shaders/screen_quad.vs", "shaders/post/blur_guassian.fs");
        ...
        // ssao
        {
            ...
            m_SSAOShader = T1::Resources::LoadShader("ssao", "shaders/screen_quad.vs", "shaders/post/ssao.fs");
            m_SSAOShader->Use();
        ...
        // bloom 
        {
            ...
            m_BloomShader = T1::Resources::LoadShader("bloom", "shaders/screen_quad.vs", "shaders/post/bloom.fs");
            m_SSAOShader->Use();
