...
namespace math
{
    ...
    */
    ...
    // this one is important; make sure to test extensively in unit tests!
    inline vec3 operator*(const quaternion& quat, const vec3& vec)
    {
        // assert that we're dealing with a unit vector
    ...
    {
        // assert that we're dealing with a unity vector
