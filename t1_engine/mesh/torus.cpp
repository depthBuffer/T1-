...
namespace T1
{
    ...
    Torus::Torus(float r1, float r2, unsigned int numSteps1, unsigned int numSteps2)
    {
        ...
        // can probably merge these steps within the for-loop conditions for 
        ...
        // no need really to pre-calculate these; integrate them within the main for 
        // loops.
        ...
        // as taken from gamedev.net resource.
