...
#include "vector.h"
#include "matrix.h"
#include <math.h> // Included this for sqrt
...
namespace math
{
    ...
    // ---------------------------------------
    template <unsigned long m, unsigned long n, typename T> // type Unsigned to Unsigned Long
    ...
    {
        matrix<m, n, T> result;
        // calculate determinant algebraically and retrieve inverse.
        return result;
    }
} // namespace math
#endif