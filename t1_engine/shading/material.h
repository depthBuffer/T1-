...
namespace T1
{
    ...
    // should be able to copy materials.
    // should not be able to change the shader of the material; this is set during creation via the renderer.
    /* 
    ...
    */
    ...
    private:
        ...
        std::map<std::string, UniformValueSampler> m_SamplerUniforms; // process samplers differently 
    public:
